...
class StoreCodeAuthorization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StoreCodeAuthorization', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmwasm.wasm.v1'), createEmptyInstance: create)
    ..pc<CodeGrant>(1, _omitFieldNames ? '' : 'grants', $pb.PbFieldType.PM, subBuilder: CodeGrant.create)
  ...
  'Will be removed in next major version')
  StoreCodeAuthorization copyWith(void Function(StoreCodeAuthorization) updates) => super.copyWith((message) => updates(message as StoreCodeAuthorization)) as StoreCodeAuthorization;
...
class CodeGrant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CodeGrant', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmwasm.wasm.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CodeGrant copyWith(void Function(CodeGrant) updates) => super.copyWith((message) => updates(message as CodeGrant)) as CodeGrant;
