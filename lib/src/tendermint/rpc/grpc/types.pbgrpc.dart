...
class BroadcastAPIClient extends $grpc.Client {
  ...
  static final _$broadcastTx = $grpc.ClientMethod<$1.RequestBroadcastTx, $1.ResponseBroadcastTx>(
      '/tendermint.rpc.grpc.BroadcastAPI/BroadcastTx',
      ($1.RequestBroadcastTx value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.ResponseBroadcastTx.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.ResponsePing> ping($1.RequestPing request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$ping, request, options: options);
  }

  $grpc.ResponseFuture<$1.ResponseBroadcastTx> broadcastTx($1.RequestBroadcastTx request, {$grpc.CallOptions? options}) {
...
abstract class BroadcastAPIServiceBase extends $grpc.Service {
  ...
  BroadcastAPIServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.RequestBroadcastTx, $1.ResponseBroadcastTx>(
        'BroadcastTx',
        broadcastTx_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.RequestBroadcastTx.fromBuffer(value),
        ($1.ResponseBroadcastTx value) => value.writeToBuffer()));
  }

  $async.Future<$1.ResponsePing> ping_Pre($grpc.ServiceCall call, $async.Future<$1.RequestPing> request) async {
    return ping(call, await request);
  }

  $async.Future<$1.ResponseBroadcastTx> broadcastTx_Pre($grpc.ServiceCall call, $async.Future<$1.RequestBroadcastTx> request) async {
    return broadcastTx(call, await request);
  }

  $async.Future<$1.ResponsePing> ping($grpc.ServiceCall call, $1.RequestPing request);
  $async.Future<$1.ResponseBroadcastTx> broadcastTx($grpc.ServiceCall call, $1.RequestBroadcastTx request);
}
