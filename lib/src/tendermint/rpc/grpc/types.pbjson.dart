...
final $typed_data.Uint8List requestPingDescriptor = $convert.base64Decode(
    'CgtSZXF1ZXN0UGluZw==');
...
final $typed_data.Uint8List requestBroadcastTxDescriptor = $convert.base64Decode(
    'ChJSZXF1ZXN0QnJvYWRjYXN0VHgSDgoCdHgYASABKAxSAnR4');
...
final $typed_data.Uint8List responsePingDescriptor = $convert.base64Decode(
    'CgxSZXNwb25zZVBpbmc=');
...
const ResponseBroadcastTx$json = {
  ...
  '2': [
    {'1': 'check_tx', '3': 1, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseCheckTx', '10': 'checkTx'},
    {'1': 'tx_result', '3': 2, '4': 1, '5': 11, '6': '.tendermint.abci.ExecTxResult', '10': 'txResult'},
  ],
};
