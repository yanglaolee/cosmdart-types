...
class CanonicalBlockID extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CanonicalBlockID', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'hash', $pb.PbFieldType.OY)
    ..aOM<CanonicalPartSetHeader>(2, _omitFieldNames ? '' : 'partSetHeader', subBuilder: CanonicalPartSetHeader.create)
  ...
  'Will be removed in next major version')
  CanonicalBlockID copyWith(void Function(CanonicalBlockID) updates) => super.copyWith((message) => updates(message as CanonicalBlockID)) as CanonicalBlockID;
...
class CanonicalPartSetHeader extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CanonicalPartSetHeader', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.types'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CanonicalPartSetHeader copyWith(void Function(CanonicalPartSetHeader) updates) => super.copyWith((message) => updates(message as CanonicalPartSetHeader)) as CanonicalPartSetHeader;
...
class CanonicalProposal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CanonicalProposal', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..e<$9.SignedMsgType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $9.SignedMsgType.SIGNED_MSG_TYPE_UNKNOWN, valueOf: $9.SignedMsgType.valueOf, enumValues: $9.SignedMsgType.values)
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'height', $pb.PbFieldType.OSF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'round', $pb.PbFieldType.OSF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aInt64(4, _omitFieldNames ? '' : 'polRound')
    ..aOM<CanonicalBlockID>(5, _omitFieldNames ? '' : 'blockId', subBuilder: CanonicalBlockID.create)
    ..aOM<$4.Timestamp>(6, _omitFieldNames ? '' : 'timestamp', subBuilder: $4.Timestamp.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CanonicalProposal copyWith(void Function(CanonicalProposal) updates) => super.copyWith((message) => updates(message as CanonicalProposal)) as CanonicalProposal;
  ...
  @$pb.TagNumber(1)
  $9.SignedMsgType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type($9.SignedMsgType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class CanonicalVote extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CanonicalVote', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..e<$9.SignedMsgType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $9.SignedMsgType.SIGNED_MSG_TYPE_UNKNOWN, valueOf: $9.SignedMsgType.valueOf, enumValues: $9.SignedMsgType.values)
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'height', $pb.PbFieldType.OSF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'round', $pb.PbFieldType.OSF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<CanonicalBlockID>(4, _omitFieldNames ? '' : 'blockId', subBuilder: CanonicalBlockID.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CanonicalVote copyWith(void Function(CanonicalVote) updates) => super.copyWith((message) => updates(message as CanonicalVote)) as CanonicalVote;
...
class CanonicalVoteExtension extends $pb.GeneratedMessage {
  ...
  factory CanonicalVoteExtension.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CanonicalVoteExtension.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CanonicalVoteExtension', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.types'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'extension', $pb.PbFieldType.OY)
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'height', $pb.PbFieldType.OSF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'round', $pb.PbFieldType.OSF6, defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CanonicalVoteExtension clone() => CanonicalVoteExtension()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CanonicalVoteExtension copyWith(void Function(CanonicalVoteExtension) updates) => super.copyWith((message) => updates(message as CanonicalVoteExtension)) as CanonicalVoteExtension;
  ...
  static $pb.PbList<CanonicalVoteExtension> createRepeated() => $pb.PbList<CanonicalVoteExtension>();
  @$core.pragma('dart2js:noInline')
  static CanonicalVoteExtension getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CanonicalVoteExtension>(create);
  static CanonicalVoteExtension? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get extension_1 => $_getN(0);
  @$pb.TagNumber(1)
  set extension_1($core.List<$core.int> v) { $_setBytes(0, v); }
  @$pb.TagNumber(1)
