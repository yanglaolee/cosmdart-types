...
const MsgInfo$json = {
  '1': 'MsgInfo',
  '2': [
    {'1': 'msg', '3': 1, '4': 1, '5': 11, '6': '.tendermint.consensus.Message', '8': {}, '10': 'msg'},
...
const TimeoutInfo$json = {
  '1': 'TimeoutInfo',
  '2': [
    {'1': 'duration', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '8': {}, '10': 'duration'},
...
final $typed_data.Uint8List endHeightDescriptor = $convert.base64Decode(
    'CglFbmRIZWlnaHQSFgoGaGVpZ2h0GAEgASgDUgZoZWlnaHQ=');

@$core.Deprecated('Use wALMessageDescriptor instead')
const WALMessage$json = {
  '1': 'WALMessage',
  '2': [
    {'1': 'event_data_round_state', '3': 1, '4': 1, '5': 11, '6': '.tendermint.types.EventDataRoundState', '9': 0, '10': 'eventDataRoundState'},
    {'1': 'msg_info', '3': 2, '4': 1, '5': 11, '6': '.tendermint.consensus.MsgInfo', '9': 0, '10': 'msgInfo'},
    {'1': 'timeout_info', '3': 3, '4': 1, '5': 11, '6': '.tendermint.consensus.TimeoutInfo', '9': 0, '10': 'timeoutInfo'},
    {'1': 'end_height', '3': 4, '4': 1, '5': 11, '6': '.tendermint.consensus.EndHeight', '9': 0, '10': 'endHeight'},
  ],
  '8': [
    {'1': 'sum'},
  ],
...
const TimedWALMessage$json = {
  ...
  '2': [
    ...
    {'1': 'msg', '3': 2, '4': 1, '5': 11, '6': '.tendermint.consensus.WALMessage', '10': 'msg'},
  ],
};
