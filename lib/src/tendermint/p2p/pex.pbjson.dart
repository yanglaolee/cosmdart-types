...
final $typed_data.Uint8List pexRequestDescriptor = $convert.base64Decode(
    'CgpQZXhSZXF1ZXN0');
...
const PexAddrs$json = {
  '1': 'PexAddrs',
  '2': [
    {'1': 'addrs', '3': 1, '4': 3, '5': 11, '6': '.tendermint.p2p.NetAddress', '8': {}, '10': 'addrs'},
  ],
};
...
const Message$json = {
  '1': 'Message',
  '2': [
    {'1': 'pex_request', '3': 1, '4': 1, '5': 11, '6': '.tendermint.p2p.PexRequest', '9': 0, '10': 'pexRequest'},
    {'1': 'pex_addrs', '3': 2, '4': 1, '5': 11, '6': '.tendermint.p2p.PexAddrs', '9': 0, '10': 'pexAddrs'},
  ],
  '8': [
    {'1': 'sum'},
  ],
