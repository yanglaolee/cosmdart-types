...
class PexRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PexRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.p2p'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PexRequest copyWith(void Function(PexRequest) updates) => super.copyWith((message) => updates(message as PexRequest)) as PexRequest;
...
class PexAddrs extends $pb.GeneratedMessage {
  factory PexAddrs({
    $core.Iterable<$15.NetAddress>? addrs,
  }) {
    final $result = create();
    if (addrs != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PexAddrs', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.p2p'), createEmptyInstance: create)
    ..pc<$15.NetAddress>(1, _omitFieldNames ? '' : 'addrs', $pb.PbFieldType.PM, subBuilder: $15.NetAddress.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PexAddrs copyWith(void Function(PexAddrs) updates) => super.copyWith((message) => updates(message as PexAddrs)) as PexAddrs;
  ...
  @$pb.TagNumber(1)
  $core.List<$15.NetAddress> get addrs => $_getList(0);
}
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Message', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.p2p'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<PexRequest>(1, _omitFieldNames ? '' : 'pexRequest', subBuilder: PexRequest.create)
    ..aOM<PexAddrs>(2, _omitFieldNames ? '' : 'pexAddrs', subBuilder: PexAddrs.create)
    ..hasRequiredFields = false
  ;
