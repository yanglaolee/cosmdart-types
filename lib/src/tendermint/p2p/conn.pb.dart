...
class PacketPing extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PacketPing', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.p2p'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PacketPing copyWith(void Function(PacketPing) updates) => super.copyWith((message) => updates(message as PacketPing)) as PacketPing;
...
class PacketPong extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PacketPong', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.p2p'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PacketPong copyWith(void Function(PacketPong) updates) => super.copyWith((message) => updates(message as PacketPong)) as PacketPong;
...
class PacketMsg extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PacketMsg', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.p2p'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PacketMsg copyWith(void Function(PacketMsg) updates) => super.copyWith((message) => updates(message as PacketMsg)) as PacketMsg;
...
class Packet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Packet', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.p2p'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<PacketPing>(1, _omitFieldNames ? '' : 'packetPing', subBuilder: PacketPing.create)
    ..aOM<PacketPong>(2, _omitFieldNames ? '' : 'packetPong', subBuilder: PacketPong.create)
    ..aOM<PacketMsg>(3, _omitFieldNames ? '' : 'packetMsg', subBuilder: PacketMsg.create)
    ..hasRequiredFields = false
  ;
...
class AuthSigMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthSigMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.p2p'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuthSigMessage copyWith(void Function(AuthSigMessage) updates) => super.copyWith((message) => updates(message as AuthSigMessage)) as AuthSigMessage;
