...
import '../types/block.pb.dart' as $11;
...
class BlockRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BlockRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.blocksync'), createEmptyInstance: create)
...
class NoBlockResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NoBlockResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.blocksync'), createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'height')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NoBlockResponse copyWith(void Function(NoBlockResponse) updates) => super.copyWith((message) => updates(message as NoBlockResponse)) as NoBlockResponse;
...
class BlockResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BlockResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.blocksync'), createEmptyInstance: create)
    ..aOM<$11.Block>(1, _omitFieldNames ? '' : 'block', subBuilder: $11.Block.create)
    ..aOM<$9.ExtendedCommit>(2, _omitFieldNames ? '' : 'extCommit', subBuilder: $9.ExtendedCommit.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $11.Block get block => $_getN(0);
  @$pb.TagNumber(1)
  set block($11.Block v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBlock() => $_has(0);
  @$pb.TagNumber(1)
  void clearBlock() => clearField(1);
  @$pb.TagNumber(1)
  $11.Block ensureBlock() => $_ensure(0);

  @$pb.TagNumber(2)
  $9.ExtendedCommit get extCommit => $_getN(1);
  @$pb.TagNumber(2)
  set extCommit($9.ExtendedCommit v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExtCommit() => $_has(1);
  @$pb.TagNumber(2)
  void clearExtCommit() => clearField(2);
  @$pb.TagNumber(2)
  $9.ExtendedCommit ensureExtCommit() => $_ensure(1);
}
...
class StatusRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatusRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.blocksync'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class StatusResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatusResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.blocksync'), createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'height')
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Message', package: const $pb.PackageName(_omitMessageNames ? '' : 'tendermint.blocksync'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5])
    ..aOM<BlockRequest>(1, _omitFieldNames ? '' : 'blockRequest', subBuilder: BlockRequest.create)
    ..aOM<NoBlockResponse>(2, _omitFieldNames ? '' : 'noBlockResponse', subBuilder: NoBlockResponse.create)
    ..aOM<BlockResponse>(3, _omitFieldNames ? '' : 'blockResponse', subBuilder: BlockResponse.create)
    ..aOM<StatusRequest>(4, _omitFieldNames ? '' : 'statusRequest', subBuilder: StatusRequest.create)
    ..aOM<StatusResponse>(5, _omitFieldNames ? '' : 'statusResponse', subBuilder: StatusResponse.create)
    ..hasRequiredFields = false
  ;
