...
class Capability extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Capability', package: const $pb.PackageName(_omitMessageNames ? '' : 'capability.v1'), createEmptyInstance: create)
...
class Owner extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Owner', package: const $pb.PackageName(_omitMessageNames ? '' : 'capability.v1'), createEmptyInstance: create)
...
class CapabilityOwners extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CapabilityOwners', package: const $pb.PackageName(_omitMessageNames ? '' : 'capability.v1'), createEmptyInstance: create)
