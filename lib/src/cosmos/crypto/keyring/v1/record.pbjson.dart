...
const Record$json = {
  ...
  '2': [
    ...
    {'1': 'local', '3': 3, '4': 1, '5': 11, '6': '.cosmos.crypto.keyring.v1.Record.Local', '9': 0, '10': 'local'},
    {'1': 'ledger', '3': 4, '4': 1, '5': 11, '6': '.cosmos.crypto.keyring.v1.Record.Ledger', '9': 0, '10': 'ledger'},
    {'1': 'multi', '3': 5, '4': 1, '5': 11, '6': '.cosmos.crypto.keyring.v1.Record.Multi', '9': 0, '10': 'multi'},
    {'1': 'offline', '3': 6, '4': 1, '5': 11, '6': '.cosmos.crypto.keyring.v1.Record.Offline', '9': 0, '10': 'offline'},
  ],
  '3': [Record_Local$json, Record_Ledger$json, Record_Multi$json, Record_Offline$json],
  '8': [
    {'1': 'item'},
  ],
};
...
const Record_Local$json = {
  '1': 'Local',
  '2': [
    {'1': 'priv_key', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Any', '10': 'privKey'},
  ],
};
...
const Record_Ledger$json = {
  '1': 'Ledger',
  '2': [
    {'1': 'path', '3': 1, '4': 1, '5': 11, '6': '.cosmos.crypto.hd.v1.BIP44Params', '10': 'path'},
  ],
};
