...
class BIP44Params extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BIP44Params', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.crypto.hd.v1'), createEmptyInstance: create)
    ...
    ..a<$core.int>(5, _omitFieldNames ? '' : 'addressIndex', $pb.PbFieldType.OU3)
  ...
  'Will be removed in next major version')
  BIP44Params copyWith(void Function(BIP44Params) updates) => super.copyWith((message) => updates(message as BIP44Params)) as BIP44Params;
