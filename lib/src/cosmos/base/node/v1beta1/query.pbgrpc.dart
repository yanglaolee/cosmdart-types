...
class ServiceClient extends $grpc.Client {
  static final _$config = $grpc.ClientMethod<$0.ConfigRequest, $0.ConfigResponse>(
  ...
  $grpc.ResponseFuture<$0.ConfigResponse> config($0.ConfigRequest request, {$grpc.CallOptions? options}) {
...
abstract class ServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.ConfigResponse> config_Pre($grpc.ServiceCall call, $async.Future<$0.ConfigRequest> request) async {
  ...
  $async.Future<$0.ConfigResponse> config($grpc.ServiceCall call, $0.ConfigRequest request);
