...
const ModuleDescriptor$json = {
  ...
  '2': [
    ...
    {'1': 'use_package', '3': 2, '4': 3, '5': 11, '6': '.cosmos.app.v1alpha1.PackageReference', '10': 'usePackage'},
    {'1': 'can_migrate_from', '3': 3, '4': 3, '5': 11, '6': '.cosmos.app.v1alpha1.MigrateFromInfo', '10': 'canMigrateFrom'},
  ],
};
...
final $typed_data.Uint8List migrateFromInfoDescriptor = $convert.base64Decode(
    'Cg9NaWdyYXRlRnJvbUluZm8SFgoGbW9kdWxlGAEgASgJUgZtb2R1bGU=');
