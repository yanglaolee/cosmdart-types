...
class ModuleDescriptor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModuleDescriptor', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.app.v1alpha1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'goImport')
    ..pc<PackageReference>(2, _omitFieldNames ? '' : 'usePackage', $pb.PbFieldType.PM, subBuilder: PackageReference.create)
    ..pc<MigrateFromInfo>(3, _omitFieldNames ? '' : 'canMigrateFrom', $pb.PbFieldType.PM, subBuilder: MigrateFromInfo.create)
  ...
  @$pb.TagNumber(1)
  set goImport($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class PackageReference extends $pb.GeneratedMessage {
  ...
  factory PackageReference.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PackageReference.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PackageReference', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.app.v1alpha1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PackageReference copyWith(void Function(PackageReference) updates) => super.copyWith((message) => updates(message as PackageReference)) as PackageReference;
  ...
  static $pb.PbList<PackageReference> createRepeated() => $pb.PbList<PackageReference>();
  @$core.pragma('dart2js:noInline')
  static PackageReference getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PackageReference>(create);
...
class MigrateFromInfo extends $pb.GeneratedMessage {
  ...
  factory MigrateFromInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MigrateFromInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MigrateFromInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.app.v1alpha1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MigrateFromInfo copyWith(void Function(MigrateFromInfo) updates) => super.copyWith((message) => updates(message as MigrateFromInfo)) as MigrateFromInfo;
  ...
  static $pb.PbList<MigrateFromInfo> createRepeated() => $pb.PbList<MigrateFromInfo>();
  @$core.pragma('dart2js:noInline')
  static MigrateFromInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MigrateFromInfo>(create);
...
class Module {
  static final module = $pb.Extension<ModuleDescriptor>(_omitMessageNames ? '' : 'google.protobuf.MessageOptions', _omitFieldNames ? '' : 'module', 57193479, $pb.PbFieldType.OM, defaultOrMaker: ModuleDescriptor.getDefault, subBuilder: ModuleDescriptor.create);
