...
class StoreInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StoreInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.store.v1beta1'), createEmptyInstance: create)
...
class CommitID extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommitID', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.store.v1beta1'), createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'version')
