...
const Pairs$json = {
  '1': 'Pairs',
  '2': [
    {'1': 'pairs', '3': 1, '4': 3, '5': 11, '6': '.cosmos.store.internal.kv.v1beta1.Pair', '8': {}, '10': 'pairs'},
  ],
};
...
final $typed_data.Uint8List pairsDescriptor = $convert.base64Decode(
    'CgVQYWlycxJCCgVwYWlycxgBIAMoCzImLmNvc21vcy5zdG9yZS5pbnRlcm5hbC5rdi52MWJldG'
    'ExLlBhaXJCBMjeHwBSBXBhaXJz');
