...
class Pairs extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Pairs', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.store.internal.kv.v1beta1'), createEmptyInstance: create)
...
class Pair extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Pair', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.store.internal.kv.v1beta1'), createEmptyInstance: create)
