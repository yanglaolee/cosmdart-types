...
class Metadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Metadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.fee.v1'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  set feeVersion($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
