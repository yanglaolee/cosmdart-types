...
class PacketFee extends $pb.GeneratedMessage {
  ...
  PacketFee._() : super();
  factory PacketFee.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PacketFee.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PacketFee', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.fee.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PacketFee copyWith(void Function(PacketFee) updates) => super.copyWith((message) => updates(message as PacketFee)) as PacketFee;
  ...
  @$core.pragma('dart2js:noInline')
  static PacketFee getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PacketFee>(create);
...
class PacketFees extends $pb.GeneratedMessage {
  ...
  PacketFees._() : super();
  factory PacketFees.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PacketFees.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PacketFees', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.fee.v1'), createEmptyInstance: create)
    ..pc<PacketFee>(1, _omitFieldNames ? '' : 'packetFees', $pb.PbFieldType.PM, subBuilder: PacketFee.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PacketFees copyWith(void Function(PacketFees) updates) => super.copyWith((message) => updates(message as PacketFees)) as PacketFees;
  ...
  @$core.pragma('dart2js:noInline')
  static PacketFees getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PacketFees>(create);
...
class IdentifiedPacketFees extends $pb.GeneratedMessage {
  ...
  factory IdentifiedPacketFees.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  IdentifiedPacketFees clone() => IdentifiedPacketFees()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IdentifiedPacketFees copyWith(void Function(IdentifiedPacketFees) updates) => super.copyWith((message) => updates(message as IdentifiedPacketFees)) as IdentifiedPacketFees;
  ...
  static $pb.PbList<IdentifiedPacketFees> createRepeated() => $pb.PbList<IdentifiedPacketFees>();
  @$core.pragma('dart2js:noInline')
  static IdentifiedPacketFees getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IdentifiedPacketFees>(create);
