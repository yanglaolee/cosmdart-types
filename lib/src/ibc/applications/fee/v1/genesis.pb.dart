...
class GenesisState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenesisState', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.fee.v1'), createEmptyInstance: create)
    ...
    ..pc<ForwardRelayerAddress>(5, _omitFieldNames ? '' : 'forwardRelayers', $pb.PbFieldType.PM, subBuilder: ForwardRelayerAddress.create)
  ...
  @$pb.TagNumber(4)
  $core.List<RegisteredCounterpartyPayee> get registeredCounterpartyPayees => $_getList(3);
...
class FeeEnabledChannel extends $pb.GeneratedMessage {
  ...
  factory FeeEnabledChannel.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FeeEnabledChannel.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeeEnabledChannel', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.fee.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeeEnabledChannel copyWith(void Function(FeeEnabledChannel) updates) => super.copyWith((message) => updates(message as FeeEnabledChannel)) as FeeEnabledChannel;
  ...
  static $pb.PbList<FeeEnabledChannel> createRepeated() => $pb.PbList<FeeEnabledChannel>();
  @$core.pragma('dart2js:noInline')
  static FeeEnabledChannel getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FeeEnabledChannel>(create);
...
class RegisteredPayee extends $pb.GeneratedMessage {
  ...
  factory RegisteredPayee.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RegisteredPayee.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RegisteredPayee', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.fee.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegisteredPayee copyWith(void Function(RegisteredPayee) updates) => super.copyWith((message) => updates(message as RegisteredPayee)) as RegisteredPayee;
  ...
  static $pb.PbList<RegisteredPayee> createRepeated() => $pb.PbList<RegisteredPayee>();
  @$core.pragma('dart2js:noInline')
  static RegisteredPayee getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RegisteredPayee>(create);
...
class RegisteredCounterpartyPayee extends $pb.GeneratedMessage {
  ...
  factory RegisteredCounterpartyPayee.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RegisteredCounterpartyPayee.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RegisteredCounterpartyPayee', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.fee.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'channelId')
    ..aOS(2, _omitFieldNames ? '' : 'relayer')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  RegisteredCounterpartyPayee clone() => RegisteredCounterpartyPayee()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegisteredCounterpartyPayee copyWith(void Function(RegisteredCounterpartyPayee) updates) => super.copyWith((message) => updates(message as RegisteredCounterpartyPayee)) as RegisteredCounterpartyPayee;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RegisteredCounterpartyPayee create() => RegisteredCounterpartyPayee._();
  RegisteredCounterpartyPayee createEmptyInstance() => create();
  static $pb.PbList<RegisteredCounterpartyPayee> createRepeated() => $pb.PbList<RegisteredCounterpartyPayee>();
  @$core.pragma('dart2js:noInline')
  static RegisteredCounterpartyPayee getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RegisteredCounterpartyPayee>(create);
  ...
  @$pb.TagNumber(3)
  set counterpartyPayee($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class ForwardRelayerAddress extends $pb.GeneratedMessage {
  ...
  factory ForwardRelayerAddress.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ForwardRelayerAddress.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ForwardRelayerAddress clone() => ForwardRelayerAddress()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ForwardRelayerAddress copyWith(void Function(ForwardRelayerAddress) updates) => super.copyWith((message) => updates(message as ForwardRelayerAddress)) as ForwardRelayerAddress;
  ...
  static $pb.PbList<ForwardRelayerAddress> createRepeated() => $pb.PbList<ForwardRelayerAddress>();
  @$core.pragma('dart2js:noInline')
  static ForwardRelayerAddress getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ForwardRelayerAddress>(create);
