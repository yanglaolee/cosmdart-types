...
class TransferAuthorization extends $pb.GeneratedMessage {
  ...
  factory TransferAuthorization.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TransferAuthorization.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransferAuthorization', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.transfer.v1'), createEmptyInstance: create)
    ..pc<Allocation>(1, _omitFieldNames ? '' : 'allocations', $pb.PbFieldType.PM, subBuilder: Allocation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TransferAuthorization clone() => TransferAuthorization()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransferAuthorization copyWith(void Function(TransferAuthorization) updates) => super.copyWith((message) => updates(message as TransferAuthorization)) as TransferAuthorization;
  ...
  static $pb.PbList<TransferAuthorization> createRepeated() => $pb.PbList<TransferAuthorization>();
  @$core.pragma('dart2js:noInline')
  static TransferAuthorization getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TransferAuthorization>(create);
