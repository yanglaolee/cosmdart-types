...
class FungibleTokenPacketData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FungibleTokenPacketData', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.transfer.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FungibleTokenPacketData copyWith(void Function(FungibleTokenPacketData) updates) => super.copyWith((message) => updates(message as FungibleTokenPacketData)) as FungibleTokenPacketData;
