...
class Metadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Metadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.applications.interchain_accounts.v1'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(2)
  set controllerConnectionId($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set hostConnectionId($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set txType($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
