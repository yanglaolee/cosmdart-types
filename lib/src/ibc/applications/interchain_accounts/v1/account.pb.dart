...
class InterchainAccount extends $pb.GeneratedMessage {
  ...
  factory InterchainAccount.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  'Will be removed in next major version')
  InterchainAccount copyWith(void Function(InterchainAccount) updates) => super.copyWith((message) => updates(message as InterchainAccount)) as InterchainAccount;
  ...
  static $pb.PbList<InterchainAccount> createRepeated() => $pb.PbList<InterchainAccount>();
  @$core.pragma('dart2js:noInline')
  static InterchainAccount getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<InterchainAccount>(create);
