...
const InterchainAccountPacketData$json = {
  ...
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.ibc.applications.interchain_accounts.v1.Type', '10': 'type'},
...
final $typed_data.Uint8List interchainAccountPacketDataDescriptor = $convert.base64Decode(
