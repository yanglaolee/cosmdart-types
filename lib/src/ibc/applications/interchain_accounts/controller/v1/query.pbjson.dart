...
final $typed_data.Uint8List queryInterchainAccountRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryInterchainAccountResponseDescriptor = $convert.base64Decode(
...
const QueryParamsResponse$json = {
  ...
  '2': [
    {'1': 'params', '3': 1, '4': 1, '5': 11, '6': '.ibc.applications.interchain_accounts.controller.v1.Params', '10': 'params'},
  ],
};
