...
final $typed_data.Uint8List queryConnectionRequestDescriptor = $convert.base64Decode(
...
const QueryConnectionResponse$json = {
  ...
  '2': [
    {'1': 'connection', '3': 1, '4': 1, '5': 11, '6': '.ibc.core.connection.v1.ConnectionEnd', '10': 'connection'},
...
final $typed_data.Uint8List queryConnectionsRequestDescriptor = $convert.base64Decode(
...
const QueryConnectionsResponse$json = {
  ...
  '2': [
    {'1': 'connections', '3': 1, '4': 3, '5': 11, '6': '.ibc.core.connection.v1.IdentifiedConnection', '10': 'connections'},
...
final $typed_data.Uint8List queryClientConnectionsRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryClientConnectionsResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryConnectionClientStateRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryConnectionClientStateResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryConnectionConsensusStateRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryConnectionConsensusStateResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List queryConnectionParamsRequestDescriptor = $convert.base64Decode(
    'ChxRdWVyeUNvbm5lY3Rpb25QYXJhbXNSZXF1ZXN0');
...
const QueryConnectionParamsResponse$json = {
  ...
  '2': [
    {'1': 'params', '3': 1, '4': 1, '5': 11, '6': '.ibc.core.connection.v1.Params', '10': 'params'},
  ],
};

/// Descriptor for `QueryConnectionParamsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryConnectionParamsResponseDescriptor = $convert.base64Decode(
