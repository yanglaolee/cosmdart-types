...
class GenesisMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenesisMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenesisMetadata copyWith(void Function(GenesisMetadata) updates) => super.copyWith((message) => updates(message as GenesisMetadata)) as GenesisMetadata;
...
class IdentifiedGenesisMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IdentifiedGenesisMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..pc<GenesisMetadata>(2, _omitFieldNames ? '' : 'clientMetadata', $pb.PbFieldType.PM, subBuilder: GenesisMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IdentifiedGenesisMetadata copyWith(void Function(IdentifiedGenesisMetadata) updates) => super.copyWith((message) => updates(message as IdentifiedGenesisMetadata)) as IdentifiedGenesisMetadata;
