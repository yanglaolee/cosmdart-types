...
class IdentifiedClientState extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  IdentifiedClientState copyWith(void Function(IdentifiedClientState) updates) => super.copyWith((message) => updates(message as IdentifiedClientState)) as IdentifiedClientState;
...
class ConsensusStateWithHeight extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConsensusStateWithHeight copyWith(void Function(ConsensusStateWithHeight) updates) => super.copyWith((message) => updates(message as ConsensusStateWithHeight)) as ConsensusStateWithHeight;
...
class ClientConsensusStates extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConsensusStates', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..pc<ConsensusStateWithHeight>(2, _omitFieldNames ? '' : 'consensusStates', $pb.PbFieldType.PM, subBuilder: ConsensusStateWithHeight.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClientConsensusStates copyWith(void Function(ClientConsensusStates) updates) => super.copyWith((message) => updates(message as ClientConsensusStates)) as ClientConsensusStates;
...
class Height extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Height', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
...
class Params extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Params', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
...
class ClientUpdateProposal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientUpdateProposal', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.core.client.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClientUpdateProposal copyWith(void Function(ClientUpdateProposal) updates) => super.copyWith((message) => updates(message as ClientUpdateProposal)) as ClientUpdateProposal;
...
class UpgradeProposal extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpgradeProposal copyWith(void Function(UpgradeProposal) updates) => super.copyWith((message) => updates(message as UpgradeProposal)) as UpgradeProposal;
