...
class MerkleRoot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MerkleRoot', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.core.commitment.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MerkleRoot copyWith(void Function(MerkleRoot) updates) => super.copyWith((message) => updates(message as MerkleRoot)) as MerkleRoot;
...
class MerklePrefix extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MerklePrefix', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.core.commitment.v1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'keyPrefix', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MerklePrefix copyWith(void Function(MerklePrefix) updates) => super.copyWith((message) => updates(message as MerklePrefix)) as MerklePrefix;
...
class MerklePath extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MerklePath', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.core.commitment.v1'), createEmptyInstance: create)
...
class MerkleProof extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MerkleProof copyWith(void Function(MerkleProof) updates) => super.copyWith((message) => updates(message as MerkleProof)) as MerkleProof;
