...
class Misbehaviour extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Misbehaviour', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.lightclients.tendermint.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'clientId')
    ..aOM<Header>(2, _omitFieldNames ? '' : 'header1', protoName: 'header_1', subBuilder: Header.create)
    ..aOM<Header>(3, _omitFieldNames ? '' : 'header2', protoName: 'header_2', subBuilder: Header.create)
    ..hasRequiredFields = false
  ;
...
class Fraction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Fraction', package: const $pb.PackageName(_omitMessageNames ? '' : 'ibc.lightclients.tendermint.v1'), createEmptyInstance: create)
